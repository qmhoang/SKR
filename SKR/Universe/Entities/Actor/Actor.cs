...
namespace SKR.Universe.Entities.Actor {
    ...
    public class ActorCharacteristics {
        ...
        public ActorCharacteristics(Person actor) {
            ...
            BodyParts = new Dictionary<BodyPartType, BodyPart>
                            {
                                    ...
                                    {BodyPartType.RightArm, new BodyPart("Right Arm", BodyPartType.RightArm, Actor, Health / 2, -2, ItemType.OneHandedWeapon, ItemType.TwoHandedWeapon, ItemType.Shield)},
                                    {BodyPartType.LeftArm, new BodyPart("Left Arm", BodyPartType.LeftArm, Actor, Health / 2, -2, ItemType.OneHandedWeapon, ItemType.TwoHandedWeapon, ItemType.Shield)},
                                    {BodyPartType.RightHand, new BodyPart("Right Hand", BodyPartType.RightHand, Actor, Health / 3, -4)},
                                    {BodyPartType.LeftHand, new BodyPart("Left Hand", BodyPartType.LeftHand, Actor, Health / 3, -4)},
            ...
            Punch = new MeleeComponent(Skill.Brawling, 0, -1, DamageType.Crush, 1, 100, 1, 0, 0, ItemAction.MeleeAttackThrust, "punch");
            Kick = new MeleeComponent(Skill.Brawling, -2, 1, DamageType.Crush, 1, 100, 1, 0, -100, ItemAction.MeleeAttackThrust, "kick");
        }
    ...
    public abstract class Person : AbstractActor {
        ...
        public IEnumerable<BodyPart> BodyParts { get { return Characteristics.BodyPartsList; } } 
...
//todo melee combat
        ...
        public int Health { get { return Characteristics.Health; } set { Characteristics.Health = value; } }
        public int MaxHealth { get { return Characteristics.MaxHealth; } }
